...
object Main {
  def main(args: Array[String]): Unit = {
    val handKinds = Seq(TileKind.M1,TileKind.S1,TileKind.S1,TileKind.S2,TileKind.M3,TileKind.M4,TileKind.M5,TileKind.M6,TileKind.M7,TileKind.M8,TileKind.M9,TileKind.M9,TileKind.M9)
